...
/**
 * @author xushuai
 * 2014年6月12日  下午2:39:03
 * Email wyxushuai@163.com
 * 
 * inspired by JackWanton viewPagerIndicator 
 * https://github.com/JakeWharton/Android-ViewPagerIndicator
 * 
 * Draws a line for each page. The current page line is colored differently
 * than the unselected page lines.
 */
public class UnderlinePageIndicator extends View implements PageIndicator ,OnClickListener{
    ...
    private List<View> mTabViews2;
    private int mSelectedTabColor;
    private int mTabViewDefaultColor;
    ...
    public void setTabDefaultColor(int selectedViewColor) {
    	mTabViewDefaultColor = selectedViewColor;
    	invalidate();
    }

    public void setSelectedTabColor(int viewSelectedColor) {
    	mSelectedTabColor = viewSelectedColor;
    	invalidate();
    }
    //设置textView监听
    public void setTabViews(List<TextView> views) {
    	mTabViews = views;
    	initTabViews(views);
    }

    private void initTabViews(List<TextView> views) {
    	for (TextView textView : views) {
    		textView.setOnClickListener(this);
		}
	}
    //设置外层布局监听
    public void setTabViews2(List<View> mViews){
    	mTabViews2 = mViews;
    	initTabViews2(mViews);
    }
    private void initTabViews2(List<View> mViews){

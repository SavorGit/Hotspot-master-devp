...
import com.common.api.widget.pulltorefresh.library.internal.FlipLoadingLayout;
import com.common.api.widget.pulltorefresh.library.internal.LoadingLayout;
import com.common.api.widget.pulltorefresh.library.internal.RotateLoadingLayout;
import com.common.api.widget.pulltorefresh.library.internal.ScaleLoadingLayout;
import com.common.api.widget.pulltorefresh.library.internal.Utils;
import com.common.api.widget.pulltorefresh.library.internal.ViewCompat;
...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout implements IPullToRefresh<T> {
	...
	private boolean isLoadAvailable; //DM：该flag为了判断当前列表已完全展示、正在上拉等不需要下拉的情况
	// ===========================================================
	// Fields
	// ===========================================================
	...
	private ISteepListener mOnSteepListener;
...
//				&& OverscrollHelper.isAndroidOverScrollEnabled(mRefreshableView);
	...
	public final void setLoadAvailable(boolean b) {
		isLoadAvailable = b;
	}
	
	public final boolean isLoadAvailable() {
...
//		handlerSteepListener(event);
	...
	public ISteepListener getOnSteepListener() {
		return mOnSteepListener;
	}

	public void setOnSteepListener(ISteepListener onSteepListener) {
		this.mOnSteepListener = onSteepListener;
	}

	// 处理沉浸式DM
	private void handlerSteepListener(MotionEvent event) {
		if (mOnSteepListener == null)
			return;
		switch(event.getAction()) {
			case MotionEvent.ACTION_DOWN:
				...
				break;
			case MotionEvent.ACTION_MOVE:
				float yValue = mInitialMotionY-mLastMotionY;
				LogUtils.i("bichao----"+yValue);
				if (yValue>20) {
					mOnSteepListener.topSteep();
				}
				if (yValue<-20) {
					mOnSteepListener.bottomSteep();
				}
				break;
...
//		}
	...
	public static enum AnimationStyle {
		...
		LoadingLayout createLoadingLayout(Context context, Mode mode, Orientation scrollDirection, TypedArray attrs) {
			switch (this) {
				...
				case SCALE:
					return new ScaleLoadingLayout(context,mode,scrollDirection,attrs);
			}
		}
	}
	...
	public static enum Orientation {
		VERTICAL, HORIZONTAL,MOVIE;
		
		public static Orientation mapIntToValue(int modeInt) {
			switch (modeInt) {
				case 0x0:
					return HORIZONTAL;
				case 0x1:

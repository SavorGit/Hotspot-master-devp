...
import com.common.api.widget.adrWheel.WheelViewAdapter;
...
public class WheelView extends View {
	...
	// Wheel drawables
	private int wheelBackground = R.drawable.adr_wheel_bg;
	private int wheelForeground = R.drawable.adr_wheel_val;

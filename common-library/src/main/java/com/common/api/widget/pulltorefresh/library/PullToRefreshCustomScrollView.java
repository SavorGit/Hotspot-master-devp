...
import com.common.api.widget.CustomScrollView;
...
public class PullToRefreshCustomScrollView extends PullToRefreshBase<CustomScrollView> {
	...
	public PullToRefreshCustomScrollView(Context context, Mode mode) {
		super(context, mode);
	}

	public PullToRefreshCustomScrollView(Context context, Mode mode, AnimationStyle style) {
	...
	final class InternalScrollViewSDK9 extends CustomScrollView {
		...
		protected boolean overScrollBy(int deltaX, int deltaY, int scrollX, int scrollY, int scrollRangeX,
			...
			OverscrollHelper.overScrollBy(PullToRefreshCustomScrollView.this, deltaX, scrollX, deltaY, scrollY,

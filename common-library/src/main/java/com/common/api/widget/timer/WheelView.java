...
public class WheelView extends View {
	...
	/** Items text color */
	private static final int ITEMS_TEXT_COLOR = 0xFFA0A0A0;
...
//		drawCenterRect(canvas);  //放在此处，字在背景色	下
		drawShadows(canvas);
	}
	 ...
	 *            scrolling duration
	 */
	public void scroll(int itemsToSkip, int time) {
		scroller.forceFinished(true);

		lastScrollY = scrollingOffset;
		int offset = itemsToSkip * getItemHeight();

...
public class XmlElement {
    ...
    transient static final Map<String, String> keys;
    ...
    public XmlElement addAttributes(Map<String, String> attributes) {
        if (attributes != null) {
            for (Map.Entry<String, String> attribute : attributes.entrySet()) {
                this.attributes.put(getKey(attribute.getKey()),
                        attribute.getValue());
            }
        }
        return this;
    ...
    public XmlElement setAttribute(String name, String value) {
        this.attributes.put(getKey(name), value);
        return this;
    }
    ...
    public XmlElement addChild(XmlElement child) {
        if (child != null && child.name != null) {
            ...
            if (!children.containsKey(child.name)) {
                children.put(getKey(child.name), new ArrayList<XmlElement>(10));
            }

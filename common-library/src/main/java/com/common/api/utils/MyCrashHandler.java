...
//
//import com.common.api.utils.AppUtils.StorageFile;
//
///**
...
//				String path=AppUtils.getPath(mContext, StorageFile.file);
//				File destFile = new File(path+fileName);
//				if (!destFile.exists()) {
//					destFile.createNewFile();
//					FileUtils.writeStringToFile(destFile, sb.toString());
//				}else {
//					FileUtils.writeStringToFile(destFile, sb.toString(), true);
//				}
//			}
//			return fileName;
//		} catch (Exception e) {

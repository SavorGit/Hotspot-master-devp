...
import com.common.api.widget.pulltorefresh.library.LoadingLayoutProxy;
import com.common.api.widget.pulltorefresh.library.PullToRefreshAdapterViewBase;
...
public class PullToRefreshSwipeListView extends
	...
	protected void onReset() {
		...
		// If the ListView header progress_loading layout is showing, then we need to
	...
	protected SwipeListView createListView(Context context, AttributeSet attrs) {
		...
		/*
		 * if (VERSION.SDK_INT >= VERSION_CODES.GINGERBREAD) { lv = new
		 * InternalListViewSDK9(context, attrs); } else { lv = new
		 * InternalListView(context, attrs); }
		 */

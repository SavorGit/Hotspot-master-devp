...
public class CustomActionSheetDialog {
    ...
    public CustomActionSheetDialog setTitle(String title) {
        showTitle = true;
    ...
    public CustomActionSheetDialog addSheetItem(String strItem, SheetItemColor color, OnSheetItemClickListener listener) {

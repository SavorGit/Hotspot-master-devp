 ...
 */
public class CustomAlertPPtDialog {
    ...
    public CustomAlertPPtDialog(Context context) {
...
//    }
    ...
    public CustomAlertPPtDialog setTitle(String title) {
        showTitle = true;
        if ("".equals(title)) {
    ...
    public CustomAlertPPtDialog setMsg(String msg) {
        showMsg = true;
        if ("".equals(msg)) {
            txt_msg.setText("内容");
        } else {
    ...
    public CustomAlertPPtDialog setInputHint(String hint) {
        showInput = true;
        if ("".equals(hint)) {
    ...
    public CustomAlertPPtDialog setCancelable(boolean cancel) {
        dialog.setCancelable(cancel);
        return this;
    }

    public CustomAlertPPtDialog setPositiveButton(String text, final OnClickListener listener) {
        showPosBtn = true;
        if ("".equals(text)) {
            btn_pos.setText("确定");
        } else {
    ...
    public CustomAlertPPtDialog setNegativeButton(String text, final OnClickListener listener) {
        showNegBtn = true;
        if ("".equals(text)) {
            btn_neg.setText("取消");
        } else {
        ...
        btn_neg.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                hashMap.put(context.getString(R.string.slide_to_screen_creat),"cancel");
                RecordUtils.onEvent(context,context.getString(R.string.slide_to_screen_creat),hashMap);
                dialog.dismiss();
            }
        });
        return this;
    ...
    public CustomAlertPPtDialog setMidButton(String text, final OnClickListener listener) {
        showMidBtn = true;
        if ("".equals(text)) {
            btn_mid.setText("取消");
        } else {
